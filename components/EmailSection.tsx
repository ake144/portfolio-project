...
const EmailSection = () => {
  ...
  return (
    ...
    >
      ...
      <div className="z-10">
        <h5 className="text-2xl font-bold black:text-white my-2 font-serif">
          Let&apos;s Connect
        </h5>
        <p className="light:text-[#ADB7BE] mb-4 max-w-md">
          I&apos;m currently looking for new opportunities. My inbox is always
          open. Whether you have a question or just want to say hi, I&apos;ll
          try my best to get back to you!
        </p>
        <div className="gap-2 w-fit">
          <p className="text-bold font-serif text-xl">
            <span className="text-sm">Call Me: </span> +251954234576
          </p>
          <div className="h-2 bg-green-500 rounded-full"></div>
          <div className="h-2 bg-indigo-500 rounded-full transition-x-8"></div>
        </div>
      </div>
      <div>
        {emailSubmitted ? (
